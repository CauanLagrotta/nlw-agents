...
export async function generateAnswer(
  ...
  const prompt = `
    ...
    - Se a resposta não for encontrada no contexto, responda com "Não foi possível encontrar uma resposta com base no contexto fornecido."
    - Seja objetivo.
    - Mantenha um tom educativo e profissional.
    - Cite trechos do contexto se apropriado.
